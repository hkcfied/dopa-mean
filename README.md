...
The build process:
1. Bundles the React app with Vite
2. Creates a 404.html for SPA routing (single-page app fallback)
3. Generates optimized shortcut URLs

### Deployment
The app is designed to be deployed on any static hosting:
...
## How the 30-Second Countdown Works

The **Intercept** page (`/open/:appId`) is the heart of Dopa-Mean:

1. **User taps the shortcut** → Opens the Intercept page with a countdown timer
2. **30-second timer starts** → A visual countdown and optional sounds/haptics
3. **User sees intentional messaging** → Reminders of why they set this up
4. **Timer expires** → Button activates to open the actual app, or user can dismiss

The timer leverages neuroscience research on impulse fading curves. After 30 seconds:
- The limbic (impulse) brain loses momentum
- The prefrontal cortex has time to ask: "Do I really want to do this?"
- Most users choose NOT to continue — creating the behavior change

---

## Philosophy

**The goal is not abstinence. The goal is awareness.**

Dopa-Mean assumes:
- You're not trying to quit social media forever
- You're trying to use it intentionally, not habitually
- You want your brain to make the decision, not your phone's notifications
- Tiny friction can outsmart billion-dollar engagement algorithms

This is not about willpower. This is about changing the environment so that the default path requires a conscious choice.

---

## Why It Works (The Research)

This app is built on peer-reviewed neuroscience:

- **Variable Ratio Reinforcement**: Skinner's research on slot machines applies to social media (Eyal, *Hooked*)
- **Craving Curves**: Peak and fade within 20-40 seconds (Wenk, *Your Brain on Food*)
- **Friction Effects**: 20 seconds of delay reduces compulsive behavior by ~50% (Thaler & Sunstein, *Nudge*)
- **Prefrontal Activation**: Forced delays activate deliberate decision-making (Goleman, *Emotional Intelligence*)
- **Neuroplasticity**: Repeated pauses literally rewire neural pathways (Doidge, *The Brain That Changes Itself*)
...
### Getting Started
```bash
git clone https://github.com/hkcfied/mindful-moment-maker.git
cd mindful-moment-maker
npm install
npm run dev
```
...
**Dopa-Mean is MIT licensed and fully open source.**

- **Source Code**: [github.com/hkcfied/mindful-moment-maker](https://github.com/hkcfied/mindful-moment-maker)
- **License**: MIT
...
Social media platforms spend billions engineering their apps to exploit your attention. They employ neuroscientists, behavioral psychologists, and ML engineers to make you scroll more, engage longer, and come back faster.

**Dopa-Mean levels the playing field.**

It's not a blocker. It's not abstinence. It's a single moment of friction — small enough that you barely notice it, powerful enough that it gives your brain time to choose.

Every pause is a small act of taking your attention back.
...
- **GitHub Issues**: [github.com/hkcfied/mindful-moment-maker/issues](https://github.com/hkcfied/mindful-moment-maker/issues)
- **Star the Repo**: If Dopa-Mean helps you, consider starring on GitHub to help spread the word
...
This project is inspired by and built on decades of research in:
- Behavioral economics (Thaler, Sunstein, Ariely)
- Neuroscience of habit formation (Duhigg, Dispenza, Doidge)
- Attention economy critique (Newport, Harris, Tristan Harris)
- Impulse control & delay discounting (Mischel, Thaler)

Dopa-Mean stands on the shoulders of giants — but the shortcut is all you.

---

**Made with care. For your brain.**

🧠 [Visit Dopa-Mean](https://dopamean.hidas.dev) — Break the scroll habit today.
